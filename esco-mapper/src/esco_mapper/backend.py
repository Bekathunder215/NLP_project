...
# TODO: WORKS
@app.get(
    "/api/v1/courses/{course_number}/occupations",
    response_model=CourseOccupationsResponse,
)
...
# TODO: WORKS
@app.get("/api/v1/occupations", response_model=OccupationDetailResponse2)
